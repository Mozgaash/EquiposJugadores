...
import com.example.equiposjugadores.model.data.Type;
import com.example.equiposjugadores.model.rest.PokemonClient;
...
public class Repository {
    ...
    private void retrieveApiClient(String url) {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://" + url + "/web/equiposjugadores/public/api/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        apiClient = retrofit.create(PokemonClient.class);
    }
